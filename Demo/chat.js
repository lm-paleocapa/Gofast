class Contact {
	...
	function addContact(image, name, id, online, lastLog) {
		...
		loadContact(name, image, online, id);  newContact.className = "active"; document.getElementById("addFriendText").style.display = "none"; document.getElementById("addFriendButton").style.display = "none"; document.getElementById("messagesPanel").style.display = ""; document.getElementById("messageList").style.display = ""; document.getElementById("messagesFooter").style.display = "";
	}
	...
	var newContact2 = new Contact("https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fcdn.pixabay.com%2Fphoto%2F2015%2F10%2F31%2F12%2F56%2Fgoogle-1015752_960_720.png&f=1&nofb=1", "google", 2, true, "online", []);
	...
	getMessage(1, "Hello", "*time*");
	getMessage(2, "Ciao", "*time2*");
	postMessage("Hello World", "taim");
